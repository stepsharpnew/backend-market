...
export class CategoryCreate1735062607828 implements MigrationInterface {
    name = 'CategoryCreate1735062607828'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "image_url" character varying NOT NULL DEFAULT '', "role" character varying NOT NULL DEFAULT 'user', "single_password" character varying DEFAULT 'user', "telegram" character varying, "refreshToken" character varying DEFAULT '', CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
