...
export class CategoryCreate1732826482066 implements MigrationInterface {
    name = 'CategoryCreate1732826482066'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "basket" ("id" SERIAL NOT NULL, "user" integer, CONSTRAINT "REL_77196502a519d80359d0b78600" UNIQUE ("user"), CONSTRAINT "PK_895e6f44b73a72425e434a614cc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "basket" ADD CONSTRAINT "FK_77196502a519d80359d0b786005" FOREIGN KEY ("user") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "basket" DROP CONSTRAINT "FK_77196502a519d80359d0b786005"`);
